...
export class CodartsResolver {
  ...
  async findOne(
    @AuthUser() owner: User,
    @Args() { code }: CodartArgs,
  ): Promise<CodartOutput> {
    try {
  ...
  async update(
    ...
    @Args('input') input: UpdateCodartInput,
  ): Promise<UpdateCodartOutput> {
    try {
